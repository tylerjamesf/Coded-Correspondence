...
#only difference from decode is the last comprehension where there is a - instead + in line 55

# ask user for the message to decode
message = input("Enter the message to be encoded: ")

# ask user for the key phrase used
key = input("Enter the key phrase to use for encoding: ")

def encode_vis(message, keyword):
